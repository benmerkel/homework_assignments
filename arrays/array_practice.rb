...
puts "The element with an index of #{array.index(4)} is #{array[3]}"
puts "The second from the last element is #{array[-2]}"
...
puts "If we add 5 at the beginning of the array, we're left with #{array.insert(0, 5)}"
